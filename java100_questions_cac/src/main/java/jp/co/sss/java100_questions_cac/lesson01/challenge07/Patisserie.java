...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("\n本日のおすすめ商品です。\n");
		System.out.println("シトロン      \\250 ・・・ 残り" + (citronStock - citron) + "個");
		System.out.println("ショコラ      \\280 ・・・ 残り" + (chocolatStock - chocolate) + "個");
		System.out.println("ピスターシュ  \\320 ・・・ 残り" + (pistacheStock - pistache) + "個");
	}
}
